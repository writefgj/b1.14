...
b={}
dup = 0
timestampDict = {"timestamp": 1555296412000}
itemSum = 0

for i in events:
    if i["firstInSession"] == True:
        b = i
    itemSum = itemSum + i["item_price"]
    if i["timestamp"]<=timestampDict["timestamp"]:
        timestampDict = i
    if i["detectedDuplicate"] == True:
        dup = dup + 1
    if i["eventType"] in a:
        a[i["eventType"]] = a[i["eventType"]] + 1
    else:
        a.update({i["eventType"]: 1})
    

print('Событий:',a)
print("Дубликатов:", dup)
print("Ид самой ранней сессии: ", timestampDict["sessionId"])
print("Сумма итемов:", itemSum)
print("Первое событие: ", b["pageViewId"])